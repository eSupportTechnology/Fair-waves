<?php echo $__env->make('layouts.newheader', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                ...
                                <div class="item items-28">
                                    <div class="grid-product-wapper">
                                        ...
                                        <div class="grid-pro-drtail-con">
                                            ...
                                            <div class="u">
                                                <!-- Show BV for dealers, otherwise show normal pricing -->
                                                <?php if(Auth::check() && Auth::user()->role === 'dealer'): ?>
                                                    <div class="bv-display" style="margin-bottom: 5px;">
                                                        <span class="bv-value" style="font-weight: bold; color: #007bff;">BV. <?php echo e(number_format($product->bv ?? 0, 2)); ?></span>
                                                    </div>
                                                <?php endif; ?>
...
<?php echo $__env->make('layouts.newfooter', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php /**PATH C:\Users\pramu\Desktop\GIT Projects\Fair-waves\resources\views/frontend/newhome.blade.php ENDPATH**/ ?>