...
<head>
    ...
    <title><?php if($returnRequest->request_type === 'cancel'): ?>Order Cancellation Request@else Product Return Request <?php endif; ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        <?php if($returnRequest->request_type === 'cancel'): ?>
        ...
        <div class="order-info">
            ...
            <div class="info-row">
                ...
                <span><strong><?php echo e($returnRequest->order_code); ?></strong></span>
            </div>
            <div class="info-row">
                <span class="info-label">Customer Name:</span>
                <span><?php echo e($returnRequest->customer_name); ?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Phone:</span>
                <span><?php echo e($returnRequest->phone); ?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Email:</span>
                <span><?php echo e($returnRequest->email); ?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Order Date:</span>
                <span><?php echo e(\Carbon\Carbon::parse($returnRequest->order_date)->format('F j, Y')); ?></span>
            </div>
            <div class="info-row">
                <span class="info-label">Request Submitted:</span>
                <span><?php echo e($returnRequest->created_at ? $returnRequest->created_at->format('F j, Y \a\t g:i A') : 'Just now'); ?></span>
            </div>
        </div>
        ...
        <div class="cancel-reason">
            ...
            <?php endif; ?>
            <p><?php echo e($returnRequest->cancel_reason); ?></p>
        </div>

        <div style="text-align: center;">
            <a href="<?php echo e(route('order-details', $returnRequest->order_code)); ?>?return_request_id=<?php echo e($returnRequest->id); ?>" class="action-button">
        ...
        <div class="footer">
            ...
            <p><strong>Timestamp:</strong> <?php echo e(now()->format('F j, Y \a\t g:i A T')); ?></p>
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\Users\pramu\Desktop\GIT Projects\Fair-waves\resources\views/emails/return-request.blade.php ENDPATH**/ ?>