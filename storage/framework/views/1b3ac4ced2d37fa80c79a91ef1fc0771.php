            ...
            <div class="col-md-9">
                <div class="tab-content terms-tab" id="v-pills-tabContent">
                            ...
                            <div class="content-section">
                                ...
                                <ol>
                                    ...
                                    <li class="title-other">Are my online transactions safe?
                                        <ol style="list-style-type: lower-alpha;">
                                            <li>
                                                Yes. We utilize the latest in digital encryption &amp; web technology to ensure that your transactions are secure and your personal details are safe when you shop at <?php echo e($companySettings->title ?? 'Fair Waves'); ?>. You can read our
                                    ...
                                    <li class="title-other">What is the <?php echo e($companySettings->title ?? 'Fair Waves'); ?> return/refund policy?
                                        <ol style="list-style-type: lower-alpha;">
                    ...
                    <div class="tab-pane fade " id="v-pills-three" role="tabpanel"
                        ...
                        <ol>
                            <li class="monial-graph">Items ordered online on <?php echo e($companySettings->title ?? 'Fair Waves'); ?> will be delivered in within 3
                    ...
                    <div class="tab-pane fade " id="v-pills-four" role="tabpanel"
                        ...
                        <p class="monial-graph">The warranty provided through the <?php echo e($companySettings->title ?? 'Fair Waves'); ?> website is the same as
                            the
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pramu\Desktop\GIT Projects\Fair-waves\resources\views/frontend/faq.blade.php ENDPATH**/ ?>