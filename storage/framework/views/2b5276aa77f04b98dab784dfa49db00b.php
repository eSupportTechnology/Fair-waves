...
<div class="content-header mb-4">
    <div>
        <h2 class="content-title card-title">Rejected Withdrawal Requests</h2>
    </div>
</div>

<div class="card mb-4">
    <div class="card-header pb-0">
        <form method="GET" action="<?php echo e(route('admin.withdrawals.rejected')); ?>" class="row g-3">
            <div class="col-md-4">
            ...
            <table class="table table-bordered align-middle">
                ...
                <tbody>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="7" class="text-center">No rejected withdrawal requests found.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
...
<?php echo $__env->make('AdminDashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\Fair-waves\resources\views/AdminDashboard/withdraw/rejected.blade.php ENDPATH**/ ?>