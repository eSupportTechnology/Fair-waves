                    ...
                    <div class="px-32 py-40 border border-gray-100 product-details__sidebar rounded-16">
                        ...
                        <div class="mb-32">
                            ...
                            <div class="flex-wrap gap-8 flex-between">
                                ...
                                <h6 class="mb-0 text-lg">Rs <?php echo e($product->fee ? $product->fee->fee : 300.00); ?></h6>
                            </div>
                        </div>
                        ...
                        <?php if(auth()->guard()->check()): ?>
                            ...
                            <!-- Buy Now Form (Add this after the Add To Cart form) -->
<form action="<?php echo e(route('buyNow.checkout', ['product_id' => $product->id])); ?>" method="GET" id="buyNowForm">
    <?php echo csrf_field(); ?>
    <input type="hidden" name="size" id="buyNowSelectedSize">
    <input type="hidden" name="color" id="buyNowSelectedColor">
    <input type="hidden" name="quantity" id="buyNowHiddenQuantity" value="1">

    <button type="submit" class="btn btn-outline-main rounded-8 fw-normal mt-16 w-100 <?php if($product->quantity == 0): ?> disabled <?php endif; ?>">
        Buy Now
    </button>
</form>
                        <?php else: ?>
                        ...
                        <div class="mt-32">
                            <div class="gap-24 px-16 py-8 bg-main-50 rounded-8 flex-between mb-14">
                                ...
                                <span class="text-sm text-neutral-600">Ship from <span class="fw-semibold"><?php echo e($companySettings->title ?? 'Fair Waves'); ?></span>
                                </span>
                            </div>
                            <div class="gap-24 px-16 py-8 mb-0 bg-main-50 rounded-8 flex-between">
                                ...
                                <span class="text-sm text-neutral-600">Sold by: <span class="fw-semibold"><?php echo e($companySettings->title ?? 'Fair Waves'); ?></span> </span>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.color-list__button').forEach(button => {
        button.addEventListener('click', () => {
            ...
            // Update both forms
            document.getElementById('selectedColor').value = selectedColor;
            document.getElementById('buyNowSelectedColor').value = selectedColor;
        });
    });
    ...
    quantityInput.addEventListener('input', function() {
        ...
        document.getElementById('buyNowHiddenQuantity').value = quantity;
    });
