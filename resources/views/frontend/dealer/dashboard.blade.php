            ...
            <i class="fas fa-eye me-1"></i>View Full Hierarchy
                ...
                <div class="stats-card">
                    ...
                    <div class="d-grid gap-3">
                        ...
                        <a href="{{ route('dealer.customer.orders') }}" class="btn btn-purple btn-sm w-100 quick-action-btn">
