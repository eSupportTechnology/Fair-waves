...
<section class="payment-section">
    <div class="container">
        <div class="row checkout-summary-container">
            ...
            <form action="{{ route('dealer.confirm.card.order', $order->order_code) }}" method="POST">
            @csrf
              ...
              <div class="tab-pane fade" id="cash-on-delivery" role="tabpanel" aria-labelledby="cash-on-delivery-tab">
                ...
                <form action="{{ route('dealer.confirm.cod.order', $order->order_code) }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-pay text-white w-100">
          ...
          <div class="card-body p-4">
            ...
            <div class="summary-details">
              <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <span style="color: #333; font-size: 16px; font-weight: 500;">Rs. {{ number_format($order->total_cost - 300, 2) }}</span>
              </div>
