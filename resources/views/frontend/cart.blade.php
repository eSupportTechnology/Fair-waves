                ...
                <div class="col-xl-3 col-lg-4">
                    ...
                    <div class="bg-color-three rounded-8 p-24">
                        ...
                        <div class="mb-0 flex-between gap-8">
                            ...
                            <span class="text-gray-900 fw-semibold">Rs {{ number_format($deliveryFee,2)}}</span>
                        </div>
                    </div>
                    <div class="bg-color-three rounded-8 p-24 mt-24">
                        <div class="flex-between gap-8">
                            <span class="text-gray-900 text-xl fw-semibold">Total</span>
                            <span class="text-gray-900 text-xl fw-semibold">Rs {{ number_format($cartItems->sum('subtotal') + $deliveryFee, 2) }}</span>
                        </div>
                    </div>
