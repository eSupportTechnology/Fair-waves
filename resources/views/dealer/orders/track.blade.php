...
<div class="tracking-header-card">
    <h4 class="tracking-header-title">Order Tracking Details My Customers</h4>
</div>
                ...
                <tr>
                    <td class="product-info">
                        <div class="d-flex align-items-center">
                            ...
                            @endif
                            <span class="product-name">{{ $item->link->product->name }}</span>
                        </div>
                    </td>
            ...
            <div class="col-md-8">
                <div class="tracking-info">
                    ...
                    <div class="tracking-detail mt-2">
                        ...
                        <a href="{{ $orderData['order']->tracking_link }}" target="_blank" class="tracking-link">Track with Courier <i class="fas fa-external-link-alt"></i></a>
                    </div>
                    @endif
                </div>
            </div>
...
<div class="tracking-container mt-4">
    <div class="progress-container mt-4">
        ...
        <div class="progress-wrapper">
            @php
                ...
                $currentStatusIndex = array_search($orderData['order']->status, array_keys($statuses));
            @endphp
    ...
    <div class="activity-log-container">
        <ul class="activity-log-timeline">
            @php
                $activityLogs = collect($orderData['order']->activity_logs ?? []);
            @endphp
