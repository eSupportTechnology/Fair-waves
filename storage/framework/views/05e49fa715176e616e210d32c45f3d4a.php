...
<aside class="navbar-aside shadow-sm" id="offcanvas_aside">
            <div class="aside-top" style="padding:0">
                <a href="<?php echo e(route('admin.index')); ?>" class="brand-wrap">
                    ...
                    <?php if($companySettings && $companySettings->logo): ?>
                        <img src="<?php echo e(asset('frontend/assets/images/222.png')); ?>" class="logo" alt="DK-Mart" style="margin-left:80%; width:80%;"/>
                    <?php else: ?>
                        <img src="<?php echo e(asset('frontend/assets/images/222.png')); ?>" class="logo" alt="DK-Mart" style="margin-left:80%; width:80%;"/>
                    <?php endif; ?>
                </a>
        ...
        </aside><?php /**PATH D:\Fair-waves\resources\views/AdminDashboard/Sidebar.blade.php ENDPATH**/ ?>