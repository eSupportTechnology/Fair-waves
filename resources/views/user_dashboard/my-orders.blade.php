...
<div id="all-orders" class="tab-content active">
    ...
    <div class="orders-content">
        ...
        <div class="order-card" data-order-id="{{ strtolower($order->order_code) }}" style="border: 1px solid #ccc; border-radius: 10px; padding: 15px; margin-bottom: 15px;">
            ...
            <div class="order-card-body d-flex align-items-center">
                ...
                <div class="order-info" style="font-size: 13px; color: black;">
                    <p><a href="#" class="order-link">Order ID:</a> <a href="#" class="order-link order-id-text">{{ $order->order_code }}</a></p>
