                        ...
                        <div class="p-16 border border-gray-100 product-card h-100 hover-border-main-600 rounded-16 position-relative transition-2">
                            ...
                            <div class="mt-16 product-card__content">
                                ...
                                <div class="mt-8 mb-20 product-card__price">
                                    <?php if($isDealer): ?>
                                        <span class="text-heading text-md fw-semibold ">Rs <?php echo e(number_format($product->normal_price, 2)); ?> (<?php echo e($product->bv ? $product->bv : '0'); ?> IV)</span>
                                    <?php else: ?>
                                        ...
                                        <div class="row gx-5">
                                            ...
                                            <main class="col-lg-7">
                                                ...
                                                <div class="mt-8 mb-3 product-price d-flex align-items-center">
                                                    <?php if($isDealer): ?>
                                                        <h6 class="mb-0">Rs <?php echo e($product->normal_price); ?> (<?php echo e($product->bv ? $product->bv : '0'); ?> IV)</h6>
                                                    <?php else: ?>
                                                        <?php if($product->affiliate_price && $product->affiliate_price != $product->normal_price): ?>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pramu\Desktop\GIT Projects\Fair-waves\resources\views/frontend/shop.blade.php ENDPATH**/ ?>