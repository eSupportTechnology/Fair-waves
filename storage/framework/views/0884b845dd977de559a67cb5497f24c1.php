...
<aside class="navbar-aside shadow-sm" id="offcanvas_aside">
            <div class="aside-top" style="padding:0">
                <a href="<?php echo e(route('affiliate')); ?>" class="brand-wrap">
                    <img src="<?php echo e(asset('frontend/assets/images/222.png')); ?>" class="logo" alt="DK-Mart" style="margin-left:80%;"/>
                </a>
                <div>
        ...
        </aside><?php /**PATH D:\Fair-waves\resources\views/AffiliateDashBoard/Sidebar.blade.php ENDPATH**/ ?>