                ...
                <div class="tab-content terms-tab" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade  show active " id="v-pills-five" role="tabpanel"
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                <label class="fs-14">Request Type<span class="req">*</span></label>
                        ...
                        document.getElementById('request_type').addEventListener('change', function() {
                            ...
                            if (requestType === 'cancel') {
                                reasonLabel.innerHTML = 'Why do you want to cancel this order?<span class="req">*</span>';
                                reasonTextarea.placeholder = 'Please explain why you want to cancel this order...';
                            } else if (requestType === 'return') {
                                reasonLabel.innerHTML = 'Why do you want to return this product?<span class="req">*</span>';
                                reasonTextarea.placeholder = 'Please explain why you want to return this product...';
                            } else {
                                reasonLabel.innerHTML = 'Please explain your reason<span class="req">*</span>';
                                reasonTextarea.placeholder = 'Please explain your reason...';
                            }
                        });
                        </script>
