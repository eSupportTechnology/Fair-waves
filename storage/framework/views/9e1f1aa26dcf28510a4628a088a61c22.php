            ...
            <div class="profile-header text-center">
                <div class="profile-image-container">
                    <?php if($dealer->profile_image): ?>
                        <img src="<?php echo e(asset('storage/' . $dealer->profile_image)); ?>" alt="Profile Image" class="profile-image">
                    <?php else: ?>
                        <img src="<?php echo e(asset('frontend/newstyle/assets/images/user-placeholder.jpg')); ?>" alt="Default Profile" class="profile-image">
                    <?php endif; ?>
                </div>
                <h4 class="mt-3"><?php echo e($dealer->name); ?></h4>
                <p class="text-muted mb-0"><?php echo e($dealer->email); ?></p>
                <span class="badge <?php echo e($dealer->dealer_status == 1 ? 'badge-soft-success' : 'badge-soft-danger'); ?> px-3 py-2 mt-2">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($referral->referredUser->name ?? 'N/A'); ?></td>
                                <td><?php echo e($referral->referredUser->email ?? 'N/A'); ?></td>
                                <td><?php echo e($referral->created_at->format('Y-m-d')); ?></td>
                                <td>
                                    <?php if($referral->referredUser && $referral->referredUser->role == 'customer'): ?>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('order-details', $order->order_code)); ?>" class="btn btn-sm btn-view">
...
<?php echo $__env->make('AdminDashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pramu\Desktop\GIT Projects\Fair-waves\resources\views/AdminDashboard/dealer-details.blade.php ENDPATH**/ ?>