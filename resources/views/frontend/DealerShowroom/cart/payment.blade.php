                        ...
                        <ul class="nav nav-tabs payment-tabs" id="paymentTabs" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link active d-flex flex-column align-items-center" id="credit-card-tab" data-bs-toggle="tab" href="#credit-card" role="tab" aria-controls="credit-card" aria-selected="true">
                                    <div class="mb-2">
                                        <img src="{{ asset('frontend/assets/images/imgs/card.png') }}" style="width: 40px; height: auto;">
                                    </div>
                            ...
                            <li class="nav-item" role="presentation">
                                <a class="nav-link d-flex flex-column align-items-center" id="cash-on-delivery-tab" data-bs-toggle="tab" href="#cash-on-delivery" role="tab" aria-controls="cash-on-delivery" aria-selected="false">
                                    <div class="mb-2">
                                        <img src="{{ asset('frontend/assets/images/imgs/cod.png') }}" style="width: 50px; height: auto;">
                                    </div>
                        ...
                        <div class="tab-content mt-4" id="paymentTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="credit-card" role="tabpanel" aria-labelledby="credit-card-tab">
                                <div class="payment-form p-4">
                                    <form action="{{ route('dealer.cart.payment.card', ['dealer_shop_name' => $dealer_shop_name, 'order_code' => $order_code]) }}" method="POST" id="card-payment-form">
                                        @csrf
                                        <div class="row">
                                        ...
                                        <button type="submit" class="btn btn-pay w-100 text-white mt-3">
                                            <i class="fas fa-lock me-2"></i>Pay Rs. {{ number_format($order->total_cost, 2) }}
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="cash-on-delivery" role="tabpanel" aria-labelledby="cash-on-delivery-tab">
                                ...
                                <form action="{{ route('dealer.cart.payment.cod', ['dealer_shop_name' => $dealer_shop_name, 'order_code' => $order_code]) }}" method="POST">
                                    @csrf
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="summary-details">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span style="color: #333; font-size: 16px; font-weight: 500;">Rs. {{ number_format($order->subtotal, 2) }}</span>
                            </div>
                            
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span style="color: #666; font-size: 16px;">Delivery Fee</span>
                                <span style="color: #333; font-size: 16px; font-weight: 500;">Rs. {{ number_format($order->delivery_fee, 2) }}</span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center total-section">
                                ...
                                <span style="color: rgb(35, 98, 225); font-size: 20px; font-weight: 600;">Rs. {{ number_format($order->total_cost, 2) }}</span>
                            </div>
                        </div>
