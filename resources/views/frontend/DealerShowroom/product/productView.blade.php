...
@if($productLink->product->quantity > 0)
    <!-- Add to Cart Form -->
    <form action="{{ route('showroom.cart.add', [$productLink->dealer->dealerProfile->dealer_shop_name, $productLink->product->id]) }}" method="POST" class="d-inline add-to-cart-form" onsubmit="return handleAddToCart(event, this);">
        @csrf
