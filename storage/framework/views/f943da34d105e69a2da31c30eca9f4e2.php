                ...
                <tr>
                    <td class="product-info">
                        <div class="d-flex align-items-center">
                            ...
                            <?php endif; ?>
                            <span class="product-name"><?php echo e($item->link->product->name); ?></span>
                        </div>
                    </td>
            ...
            <div class="col-md-8">
                <div class="tracking-info">
                    ...
                    <div class="tracking-detail mt-2">
                        ...
                        <a href="<?php echo e($orderData['order']->tracking_link); ?>" target="_blank" class="tracking-link">Track with Courier <i class="fas fa-external-link-alt"></i></a>
                    </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('layouts.user_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\Fair-waves\resources\views/dealer/orders/track.blade.php ENDPATH**/ ?>