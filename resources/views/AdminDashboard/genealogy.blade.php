...
@section('title', 'Dealers Genealogy Tree')
...
<div class="genealogy-container">
    ...
    <div class="stats-overview">
        <div class="stat-card">
            <div class="stat-value">{{ $totalDealers }}</div>
            <div class="stat-label">Total Dealers</div>
        </div>
        <div class="stat-card">
            <div class="stat-value">{{ $activeDealers }}</div>
            <div class="stat-label">Active Dealers</div>
        </div>
        <div class="stat-card">
            <div class="stat-value">{{ $inactiveDealers }}</div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            ...
            <div class="tree-controls">
                ...
                <a href="{{ route('admin.index') }}" class="tree-control-btn">
            ...
            <div class="genealogy-tree-wrapper" style="position: relative;">
                <div class="tree-scroll-container">
                    <div class="tree-content">
                        @include('AdminDashboard.partials.genealogy-tree-node', ['node' => $completeTree, 'isRoot' => true])
                    </div>
                </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <div class="no-dealers-message">
                ...
                <a href="{{ route('dealers') }}" class="btn btn-primary">
                    <i class="fas fa-plus"></i>
                    View Dealers
                </a>
            </div>
