                ...
                <div class="address-card">
                    ...
                    <div class="address-card-content">
                        <div class="address-info-row">
                            ...
                            <span><?php echo e($address->phone_num); ?></span>
                        </div>
                        <div class="address-info-row">
                    ...
                    <div class="address-card-actions">
                        <button class="action-btn edit-btn" onclick="openEditPopup(<?php echo e(json_encode($address)); ?>)">
                            <i class="fas fa-edit"></i> Edit
                        </button>
                        <form action="<?php echo e(route('address.delete', $address->id)); ?>" method="POST" style="display: inline;">
                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.user_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pramu\Desktop\GIT Projects\Fair-waves\resources\views/user_dashboard/addresses.blade.php ENDPATH**/ ?>