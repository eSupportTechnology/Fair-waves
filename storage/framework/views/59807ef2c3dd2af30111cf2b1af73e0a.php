...
<html lang="en">
    ...
    <head>
        ...
        <title><?php echo e($companySettings->title ?? 'Fair Waves'); ?> - Order Update</title>
        <style>
            body {
                margin: 0;
                padding: 0;
    ...
    <body>
        <div class="email-container">
            ...
            <div class="footer">
                <p><span class="thank-you">Thank you for shopping with <?php echo e($companySettings->title ?? 'Fair Waves'); ?>! 🌊</span></p>
                <p>We appreciate your business and look forward to serving you again.</p>

                <div class="company-info">
                    <p><strong class="brand-accent"><?php echo e($companySettings->title ?? 'Fair Waves'); ?></strong> - Enjoy Life with the Waves</p>
