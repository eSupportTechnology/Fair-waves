...
<footer class="footer-section bg-dark text-white">
    <div class="container">
            ...
            <div class="col-lg-2 col-md-6 mb-4">
                <div class="footer-widget">
                    ...
                    {{-- <ul class="list-unstyled">
                        <li class="mb-2"><a href="{{ route('home') }}" class="text-muted text-decoration-none hover-orange">Home</a></li>
                        <li class="mb-2"><a href="{{ route('products') }}" class="text-muted text-decoration-none hover-orange">Products</a></li>
                        <li class="mb-2"><a href="{{ route('about') }}" class="text-muted text-decoration-none hover-orange">About Us</a></li>
                        <li class="mb-2"><a href="{{ route('contact') }}" class="text-muted text-decoration-none hover-orange">Contact</a></li>
                    </ul> --}}
                    <ul class="list-unstyled">
        ...
        <div class="row border-top border-secondary py-3">
            <div class="col-md-6">
                <p class="text-muted mb-0">© {{ date('Y') }} Fair Waves. All rights reserved.</p>
            </div>
