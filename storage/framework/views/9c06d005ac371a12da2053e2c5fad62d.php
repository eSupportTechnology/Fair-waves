<?php $__env->startSection('content'); ?>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $fees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>Rs. <?php echo e(number_format($fee->fee, 2)); ?></td>
                                <td class="text-end">
                                    <a href="<?php echo e(route('fees.edit', $fee)); ?>" class="btn btn-warning btn-sm me-2">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form id="deleteForm<?php echo e($fee->id); ?>"
                                        action="<?php echo e(route('fees.destroy', $fee->id)); ?>" method="POST"
                                        style="display: inline;">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="button" class="btn btn-danger btn-sm"
                                            onclick="confirmDelete('deleteForm<?php echo e($fee->id); ?>', 'Are you sure you want to delete this fee?')">
    ...
    <script>
        document.getElementById('saveFeeBtn').addEventListener('click', function () {
            ...
            fetch('<?php echo e(route('fees.store')); ?>', {
                method: 'POST',
                body: formData,
                headers: {
...
<?php echo $__env->make('AdminDashboard.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\Fair-waves\resources\views/AdminDashboard/fee/index.blade.php ENDPATH**/ ?>