                            ...
                            <div class="dealer-profile-wrapper me-3">
                                ...
                                <?php else: ?>
                                    <div class="dealer-profile-placeholder">
                                        <?php echo e(substr($dealer->name, 0, 1)); ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="dealer-info d-flex align-items-center">
                            ...
                            <div class="dealer-profile-wrapper me-3">
                                ...
                                <?php if($fallback_dealer && $fallback_dealer->profile_image): ?>
                                    <img src="<?php echo e($fallback_dealer->profile_image_url); ?>"
                                         alt="<?php echo e($fallback_dealer->name); ?>"
                                         class="dealer-profile-img">
                                <?php elseif($fallback_dealer): ?>
                                    <div class="dealer-profile-placeholder">
                                        <?php echo e(substr($fallback_dealer->name, 0, 1)); ?>
                        ...
                        <div class="dealer-content">
                            <h3 class="dealer-name mb-1 text-dark fw-bold">
                                ...
                                <?php elseif($fallback_dealer && $fallback_dealer->dealerProfile): ?>
                                    <a href="<?php echo e(route('showroom.index', $fallback_dealer->dealerProfile->dealer_shop_name)); ?>" class="text-dark text-decoration-none">
                                        <?php echo e($fallback_dealer->dealerProfile->dealer_shop_name); ?>
