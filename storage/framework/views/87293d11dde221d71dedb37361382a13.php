...
<div class="mt-5 site-common-con-2" style="
    padding-top: 50px;
">
    <div class="row" style="
    padding-top: 50px;
">
        <div class="col-12 col-xl-6">
            ...
            <h3 class="about-sub-head">We, at <?php echo e($companySettings->title ?? 'Fair Waves'); ?>, offer you the convenience of browsing, purchasing, and
...
">
        <div class="col-xl-12">
            <h2 class="text-center page-title-wrap"><?php echo e($companySettings->title ?? 'Fair Waves'); ?> Fact Check</h2>
        </div>
    </div>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Manulas Doc\Project\Intern\Project\Fair-waves\resources\views/frontend/about.blade.php ENDPATH**/ ?>