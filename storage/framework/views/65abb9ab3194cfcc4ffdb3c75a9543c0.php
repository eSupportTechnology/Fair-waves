                ...
                <ul class="flex-wrap gap-8 flex-align">
                    <li class="text-sm">
                        <a hre                                <tr>
                                <td>Email :</td>
                                <td>
                                    <a href="mailto:<?php echo e($companySettings->email ?? 'fairwaves@gmail.com'); ?>"><?php echo e($companySettings->email ?? 'fairwaves@gmail.com'); ?></a>
                                </td>
                            </tr>           <!--tr>
                                <td>Email :</td>
                                <td>
                                    <a href="mailto:{
                                    { $companySettings->email ?? 'fairwaves@gmail.com' }}"><?php echo e($companySettings->email ?? 'fairwaves@gmail.com'); ?></a>
                                </td>
                            </tr>                   <td>
                                    <a href="mailto:{
                                    { $companySettings->email ?? 'fairwaves@gmail.com' }}"><?php echo e($companySettings->email ?? 'fairwaves@gmail.com'); ?></a>
                ...
                <div class="tab-content terms-tab" id="v-pills-tabContent">
                    <div class="tab-pane fade " id="v-pills-one" role="tabpanel" aria-labelledby="v-pills-one-tab">
                        <div id="accordion" role="tablist">
                            ...
                            <p>Welcome to <?php echo e($companySettings->website ?? 'www.fairwaves.lk'); ?>, the online purchasing platform for Abans PLC (Sri Lanka).
                                The <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> website provides services to its valued customers under the following
                            ...
                            <h3 class="title-terms">Product information at <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> website</h3>
                            <p>The <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> website attempts to be as accurate as possible with the information
                                displayed on the site. However, <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> does not guarantee that product
                                descriptions or other content on this site are 100% accurate, complete, reliable or
                                completely free of errors. If a product offered by <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> is not as described on
                            ...
                            <p>In case the item received is found defective, customers should immediately inform
                                <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> within 24 hours to arrange a replacement with a brand-new unit or a full
                                refund will be provided if the stock is unavailable. </p>

                            <p>Regarding the items sold through <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>, the price of an item cannot be confirmed
                            ...
                            <p>Due to current international exchange laws and conventions, even if delivery of the
                                selected item is canceled, <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> cannot refund your money. You will, however, be
                            ...
                            <div class="content-section">
                                ...
                                <ul>
                                    ...
                                    <li>In the event of purchasing an AC unit with low capacity, the consumer is only
                                        ...
                                        to a
                                        unit with a higher capacity. <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> will not be issuing refunds for these
                                        cases.</li>
                                ...
                                <p class="pt-2 pb-2">The prices for all the items mentioned on <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> are the
                                    final
                                    and last prices of
                            ...
                            <div class="content-section">
                                <h3 class="title-terms">Using <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> accounts</h3>
                                <p>It is the responsibility of the users of this site to keep their passwords, other
                                    ...
                                    <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> account or their passwords and BuyAbans shall be indemnified from any
                                    such
                                    liability.</p>
                            </div>

                            <div class="content-section">
                                <h3 class="title-terms">Abans Duty Free purchase via <?php echo e($companySettings->website ?? 'www.fairwaves.lk'); ?></h3>
                            ...
                            <div class="content-section">
                                ...
                                <p>The warranty provided through the <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> website is the same as the common
                                    warranty
                            ...
                            <div class="content-section">
                                ...
                                <p><?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> may exchange the purchased item on valid for another item requested by
                                    the
                                ...
                                <p><?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> is not allowed to exchange any goods purchased at the BIA Duty Free
                                    unless
                                    the products sold contain internal technical faults. <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> can only provide
                            ...
                            <div class="content-section">
                                <h3 class="title-terms">Policy for information gathered by <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?></h3>
                                <p>

                                    All information entered in to <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> by site visitors will be collected and
                                    ...
                                    with
                                    affiliates of <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>.</p>
                            ...
                            <div class="content-section">
                                ...
                                <p>
                                    ...
                                    The content of the <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> site is the property of Abans PLC (Sri Lanka) and is
                                    protected under international copyright laws. The trademark of <?php echo e($companySettings->website ?? 'www.fairwaves.lk'); ?> is a
                            ...
                            <div class="content-section">
                                <h3 class="title-terms">Communication between you and <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?></h3>
                                <p>

                                    When you visit the <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> website or communicate with <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> via
                                    e-mails,
                                    you are considered as communicating with <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>. This permits <?php echo e($companySettings->website ?? 'fairwaves.lk'); ?> to
                                    send
                            ...
                            <div class="content-section">
                                ...
                                <div class="border-box-table">
                                    <p><strong><?php echo e($companySettings->website ?? 'www.fairwaves.lk'); ?></strong></p>
                                    <p><?php echo e($companySettings->address ?? 'No. 498, Galle Road, Colombo 03. Sri Lanka.'); ?></p>
                                    <table>
                                        <tr>
                                            <td>Tel</td>
                                            <td> : <?php echo e($companySettings->contact ?? '+94 112 222 888'); ?></td>
                                        </tr>

                                        <tr>
                                            <td>Web </td>
                                            <td> : <?php echo e($companySettings->website ?? 'www.fairwaves.lk'); ?></td>
                                        </tr>
                    ...
                    <div class="tab-pane fade  show active " id="v-pills-two" role="tabpanel"
                        ...
                        <p class="monial-graph">We, <?php echo e($companySettings->title ?? 'FairWaves'); ?>, having its registered office at <?php echo e($companySettings->address ?? 'No. 498, Galle Road, Colombo 03'); ?> are pleased to provide our policy on privacy for the users of our
                            website <a href="https://<?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>"><?php echo e($companySettings->website ?? 'fairwaves.lk'); ?></a>. We collect, use, maintain and
                            disclose
                            ...
                            effort to protect the privacy of users of our website, <a
                                href="https://<?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>"><?php echo e($companySettings->website ?? 'fairwaves.lk'); ?></a>.</p>
                        <p class="monial-graph">We receive your personal information such as Name, Address, E-mail
                            ...
                            store the information you submit voluntarily when you use our website, <a
                                href="https://<?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>"><?php echo e($companySettings->website ?? 'fairwaves.lk'); ?></a>. You can always refuse to provide personal
                        ...
                        <p class="monial-graph">The information contained on <a
                                href="https://<?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>"><?php echo e($companySettings->website ?? 'fairwaves.lk'); ?></a>
                            website is for general information purposes only. The <a
                                href="https://<?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>"><?php echo e($companySettings->website ?? 'fairwaves.lk'); ?></a> website assumes no responsibility for
                            errors or
                            omissions in the content of the services. In no event shall <a
                                href="https://<?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>"><?php echo e($companySettings->website ?? 'fairwaves.lk'); ?></a> website be liable for any special, direct,
                            ...
                            modifications to the content on the services at any time without prior notice. The <a
                                href="https://<?php echo e($companySettings->website ?? 'fairwaves.lk'); ?>"><?php echo e($companySettings->website ?? 'fairwaves.lk'); ?></a> website does not warrant that the website
                            is
                        ...
                        <table style="margin-bottom: 1rem;">
                            <tr>
                                <td>Tel :</td>
                                <td><a href="tel:<?php echo e($companySettings->contact ?? '+94 112 222 888'); ?>"><?php echo e($companySettings->contact ?? '+94 112 222 888'); ?></a></td>
                            </tr>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\pramu\Desktop\GIT Projects\Fair-waves\resources\views/frontend/PrivacyPolicy.blade.php ENDPATH**/ ?>